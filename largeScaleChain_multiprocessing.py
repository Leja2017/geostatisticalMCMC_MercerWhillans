...
if __name__=='__main__':
    ...
    glacier_data_path = Path(r'MercerWhillansDataGridded.csv')
    sgs_bed_path = Path(r'sgs_bed_MercerWhillans.txt')
    data_weight_path = Path(r'data_weight_MercerWhillans.txt')
    seed_file_path = Path(r'200_seeds.txt')
    output_path = Path(r'./Data/MercerWhillans')

    # Multiprocessing params
    n_iter = 1850000
    offset_idx = 0 # Which seed to start from (0-9) # TODO: CHECK BEFORE EACH RUN
    n_chains = 10
    ...
    df_sampled = df.sample(frac=0.35, random_state=rng_seed) # TODO: LOG CHANGE OF frac=0.5
    ...
    # V1_p = V1.parameters # TODO: CHECK
    V1_p = [79999.99999999999, 0.3214001952550481, 1.0607882817188607, 0] # TODO: CHANGE LOG
    ...
    largeScaleChain.set_loss_type(sigma_mc=3, massConvInRegion=True)
    
    #range_max and range_min changes topographies features' lateral scale
    #by default, I set range_max to variogram range
    range_max_x = 50e3 #in terms of meters in lateral dimension, regardless of resolution of the map TODO: CHANGE ACCORDINGLY
    range_max_y = 50e3 # TODO: CHANGE ACCORDINGLY
    range_min_x = 10e3 # TODO: CHANGE ACCORDINGLY
    range_min_y = 10e3 # TODO: CHANGE ACCORDINGLY
    scale_min = 50 #in terms of meters in vertical dimension, how much you want to multiply the perturbation by TODO: CHANGE ACCORDINGLY
    scale_max = 150 # TODO: CHANGE ACCORDINGLY
    nugget_max = 0
    ...
    min_block_x = 50 # TODO: CHANGE ACCORDINGLY
    max_block_x = 80 # TODO: CHANGE ACCORDINGLY
    min_block_y = 50 # TODO: CHANGE ACCORDINGLY
    max_block_y = 80 # TODO: CHANGE ACCORDINGLY
    ...
    '''
    largeScaleChain.set_crf_data_weight(rf1) # TODO: DELETE AFTER FIRST USE
    largeScaleChain.set_update_type('CRF_weight') # TODO: DELETE AFTER FIRST USE
    np.savetxt('data_weight_MercerWhillans.txt', largeScaleChain.crf_data_weight) # TODO: DELETE AFTER FIRST USE
    '''
    ...
    initial_beds = []
    for i in range(n_chains):
        sgs_bed = np.loadtxt('MercerWhillans_sgs_bed_'+str(i)+'.txt')
        #sgs_bed = np.loadtxt('sgs_bed_MercerWhillans.txt')
